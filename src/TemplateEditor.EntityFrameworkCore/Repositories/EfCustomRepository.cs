...
namespace TemplateEditor.Repositories;

public class EfCustomRepository<TEntity> : EfCoreRepository<TemplateEditorDbContext, TEntity, Guid>,
    ICustomRepository<TEntity>
    where TEntity : class, IEntity<Guid>
{
    public EfCustomRepository(IDbContextProvider<TemplateEditorDbContext> dbContextProvider) : base(dbContextProvider)
    {
    }
